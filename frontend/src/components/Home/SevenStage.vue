...
const steps = [
  ...
  {base:"TLS (Transport Layer Security) - 傳輸層安全性協定", detail:"這是 <strong>SSL 的現代安全後繼者</strong>。 它是<strong>當前網站 HTTPS 加密的標準技術</strong>，也就是您在瀏覽器上看到的那個「鎖頭」，用於保護您的 transmisión 資料安全。", color:colorGroups.group6, layer: '表示層'},
